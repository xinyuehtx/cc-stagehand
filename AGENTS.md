# AGENTS.md — Stagehand Claude Code Skill Agent
...
| 变量名 | 说明 | 示例 |
|--------|------|------|
| `BROWSER_PROXY` | 浏览器代理服务器（优先级最高） | `http://127.0.0.1:7890` |
| `HTTPS_PROXY` | HTTPS 代理（回退） | `http://127.0.0.1:7890` |
| `HTTP_PROXY` | HTTP 代理（回退） | `http://127.0.0.1:7890` |
| `ALL_PROXY` | 全局代理（最低优先级回退） | `socks5://127.0.0.1:7891` |
